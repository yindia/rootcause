...
func (t *Toolset) Register(reg mcp.Registry) error {
	tools := []mcp.ToolSpec{
		...
		{
			Name:        "k8s.argocd_detect",
			Description: "Detect ArgoCD API groups, resources, and control-plane namespaces.",
			ToolsetID:   t.ID(),
			InputSchema: schemaEcosystemDetect(),
			Safety:      mcp.SafetyReadOnly,
			Handler:     t.handleArgoCDDetect,
		},
		{
			Name:        "k8s.flux_detect",
			Description: "Detect Flux API groups, resources, and control-plane namespaces.",
			ToolsetID:   t.ID(),
			InputSchema: schemaEcosystemDetect(),
			Safety:      mcp.SafetyReadOnly,
			Handler:     t.handleFluxDetect,
		},
		{
			Name:        "k8s.cert_manager_detect",
			Description: "Detect cert-manager API groups, resources, and control-plane namespaces.",
			ToolsetID:   t.ID(),
			InputSchema: schemaEcosystemDetect(),
			Safety:      mcp.SafetyReadOnly,
			Handler:     t.handleCertManagerDetect,
		},
		{
			Name:        "k8s.kyverno_detect",
			Description: "Detect Kyverno API groups, resources, and control-plane namespaces.",
			ToolsetID:   t.ID(),
			InputSchema: schemaEcosystemDetect(),
			Safety:      mcp.SafetyReadOnly,
			Handler:     t.handleKyvernoDetect,
		},
		{
			Name:        "k8s.cilium_detect",
			Description: "Detect Cilium API groups, resources, and control-plane namespaces.",
			ToolsetID:   t.ID(),
			InputSchema: schemaEcosystemDetect(),
			Safety:      mcp.SafetyReadOnly,
		...
		},
		{
			...
			Safety:      mcp.SafetyReadOnly,
			Handler:     t.handleDiagnoseArgoCD,
		},
		{
			Name:        "k8s.diagnose_flux",
			Description: "Diagnose Flux reconciliation health and warning events.",
			ToolsetID:   t.ID(),
			InputSchema: schemaEcosystemDiagnose(),
			Safety:      mcp.SafetyReadOnly,
			Handler:     t.handleDiagnoseFlux,
		},
		{
			Name:        "k8s.diagnose_cert_manager",
			Description: "Diagnose cert-manager certificate/issuer readiness and warning events.",
			ToolsetID:   t.ID(),
			InputSchema: schemaEcosystemDiagnose(),
			Safety:      mcp.SafetyReadOnly,
			Handler:     t.handleDiagnoseCertManager,
		},
		{
			Name:        "k8s.diagnose_kyverno",
			Description: "Diagnose Kyverno policy readiness, report failures, and warning events.",
			ToolsetID:   t.ID(),
			InputSchema: schemaEcosystemDiagnose(),
			Safety:      mcp.SafetyReadOnly,
			Handler:     t.handleDiagnoseKyverno,
		},
		{
			Name:        "k8s.diagnose_cilium",
			Description: "Diagnose Cilium endpoint/policy/node health and warning events.",
			ToolsetID:   t.ID(),
			InputSchema: schemaEcosystemDiagnose(),
			Safety:      mcp.SafetyReadOnly,
		...
		},
		{
			...
			Description: "Run read-only preflight checks before mutating operations.",
			ToolsetID:   t.ID(),
			InputSchema: schemaSafeMutationPreflight(),
			Safety:      mcp.SafetyReadOnly,
			Handler:     t.handleSafeMutationPreflight,
		},
		{
			Name:        "k8s.create",
